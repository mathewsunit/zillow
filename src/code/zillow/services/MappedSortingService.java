...
import code.zillow.classes.MappedComparatorFactory;
 ...
 * */
public class MappedSortingService {

    /*
    * Function that sorts the input according to the field and ascending or descending order
    * Works by trying to obtain an approprriate Comparator at from a previously
    * created mapping of field to comparator, based on the field and order.
    ...
    */
    ...
    public static List<Person> sort(Iterable<Person> people, String sortField, String ascending) {
        ...
        if (ascending.equalsIgnoreCase("true") || ascending.equalsIgnoreCase("false")) {
            Comparator comparator = MappedComparatorFactory.getInstance(sortField, ascending.equalsIgnoreCase("true"));
